...
export default function Entrance() {
  ...
  return (
    <>
      <div className="relative flex flex-col items-center border-2 border-black rounded-md w-[500px] bg-gray-500">
        <div className="flex justify-center items-center p-8 text-8xl text-white">
          LifePlug
        </div>
        <div
          className="relative border-2 border-black w-[400px] h-[30px] mb-4 overflow-hidden group cursor-pointer"
